/*! p5.js v0.4.7 July 17, 2015 */ ! function(a) {
  ...
  return function a(b, c, d) {
    ...
    2: [function(a, b, c) {
      "use strict";
      var d = a("../core/core");
      a("./p5.Geometry3D"), d.prototype.plane = function(a, b, c, e) {
        a = a || 1, b = b || 1, c = c || 1, e = e || 1;
        var f = "plane|" + a + "|" + b + "|" + c + "|" + e;
        if (!this._graphics.geometryInHash(f)) {
          ...
          var i = g.generateObj();
          this._graphics.initBuffer(f, i)
        }
        this._graphics.drawBuffer(f)
      }, d.prototype.sphere = function(a, b, c) {
        a = a || 50, b = b || 10, c = c || 6;
        var e = "sphere|" + a + "|" + b + "|" + c;
        if (!this._graphics.geometryInHash(e)) {
          var f = new d.Geometry3D,
            g = function(b, c) {
              var e = 2 * Math.PI * b,
          ...
          f.parametricGeometry(g, b, c);
          var h = f.generateObj();
          this._graphics.initBuffer(e, h)
        }
        return this._graphics.drawBuffer(e), this
      }, d.prototype.cylinder = function(a, b, c, e) {
        a = a || 50, b = b || 50, c = c || 12, e = e || 8;
        var f = "cylinder|" + a + "|" + b + "|" + c + "|" + e;
        if (!this._graphics.geometryInHash(f)) {
          var g = new d.Geometry3D,
            h = function(c, e) {
              var f = 2 * Math.PI * c,
          ...
          g.parametricGeometry(h, c, e), g.mergeVertices();
          var i = function(c, e) {
            var f = 2 * Math.PI * c,
              g = a * Math.sin(-f),
              h = b,
          ...
          g.parametricGeometry(i, c, 1, g.vertices.length);
          var j = function(c, e) {
            var f = 2 * Math.PI * c,
              g = a * Math.sin(f),
              h = -b,
          ...
          g.parametricGeometry(j, c, 1, g.vertices.length);
          var k = g.generateObj(!0);
          this._graphics.initBuffer(f, k)
        }
        return this._graphics.drawBuffer(f), this
      }, d.prototype.cone = function(a, b, c, e) {
        a = a || 50, b = b || 50, c = c || 10, e = e || 6;
        var f = "cone|" + a + "|" + b + "|" + c + "|" + e;
        if (!this._graphics.geometryInHash(f)) {
          var g = new d.Geometry3D,
            h = function(c, e) {
          ...
          g.parametricGeometry(i, c, 1, g.vertices.length);
          var j = g.generateObj(!0);
          this._graphics.initBuffer(f, j)
        }
        return this._graphics.drawBuffer(f), this
      }, d.prototype.torus = function(a, b, c, e) {
        a = a || 50, b = b || 20, c = c || 12, e = e || 6;
        var f = "torus|" + a + "|" + b + "|" + c + "|" + e;
        if (!this._graphics.geometryInHash(f)) {
          var g = new d.Geometry3D,
            h = function(c, e) {
        ...
        var e = typeof arguments[3] === Number ? arguments[3] : 1,
          ...
          g = "cube|" + a + "|" + b + "|" + c + "|" + e + "|" + f;
        if (!this._graphics.geometryInHash(g)) {
          ...
          this._graphics.initBuffer(g, o)
        }
        return this._graphics.drawBuffer(g), this
      }, b.exports = d
    }, {
      "../core/core": 17,
      "./p5.Geometry3D": 4
    ...
    3: [function(a, b, c) {
      ...
      d.prototype.normalMaterial = function() {
        ...
        return this._graphics.materialInHash(a) || this._graphics.initShaders("normalVert", "normalFrag"), this._graphics.saveShaders(a), this
      }, d.prototype.basicMaterial = function(a, b, c, d) {
        a = a / 255 || .5, b = b / 255 || a, c = c / 255 || a, d = d || 1;
        var e = "normalVert|basicFrag";
        return this._graphics.materialInHash(e) || this._graphics.initShaders("normalVert", "basicFrag"), this._graphics.saveShaders(e), this
      }, b.exports = d
    }, {
      "../core/core": 17
    }],
    ...
    5: [function(a, b, c) {
      ...
      d.Matrix = function() {
        ...
        var a, b, c;
        arguments[0] instanceof d.Vector ? (a = arguments[0].x, b = arguments[0].y, c = arguments[0].z) : arguments[0] instanceof Array ? (a = arguments[0][0], b = arguments[0][1], c = arguments[0][2]) : (a = arguments[0] || 1, b = arguments[1] || 1, c = arguments[2] || 1);
        for (var e = new g(16), f = 0; f < this.mat4.length; f++) {
          var h = f % 4;
          switch (h) {
            case 0:
              e[f] = this.mat4[f] * a;
    ...
    6: [function(a, b, c) {
      ...
      d.Renderer3D = function(a, b, c) {
        ...
        try {
          if (this.drawingContext = this.canvas.getContext("webgl", i) || this.canvas.getContext("experimental-webgl", i), null === this.drawingContext) throw "Error creating webgl context";
          console.log("p5.Renderer3D: enabled webgl context")
        } catch (e) {
          console.error(e)
        }
        return this.isP3D = !0, f = this.drawingContext, f.clearColor(1, 1, 1, 1), f.clearDepth(1), f.enable(f.DEPTH_TEST), f.depthFunc(f.LEQUAL), f.clear(f.COLOR_BUFFER_BIT | f.DEPTH_BUFFER_BIT), f.viewport(0, 0, f.drawingBufferWidth, f.drawingBufferHeight), this.initHash(), this.initMatrix(), this
        ...
        d.Renderer.prototype.resize.call(this, a, b), f.viewport(0, 0, f.drawingBufferWidth, f.drawingBufferHeight)
      }, d.Renderer3D.prototype.background = function() {
        var a = this._pInst.color.apply(this._pInst, arguments),
          b = a.color_array[0] / 255,
          c = a.color_array[1] / 255,
          d = a.color_array[2] / 255,
          e = a.color_array[3] / 255;
        f.clearColor(b, c, d, e), f.clear(f.COLOR_BUFFER_BIT | f.DEPTH_BUFFER_BIT), this.resetMatrix(), this.emptyShaderStack()
      }, d.Renderer3D.prototype.initShaders = function(a, b) {
        var c = f.createShader(f.VERTEX_SHADER);
        if (f.shaderSource(c, e[a]), f.compileShader(c), !f.getShaderParameter(c, f.COMPILE_STATUS)) return alert("Yikes! An error occurred compiling the shaders:" + f.getShaderInfoLog(c)), null;
        var d = f.createShader(f.FRAGMENT_SHADER);
        if (f.shaderSource(d, e[b]), f.compileShader(d), !f.getShaderParameter(d, f.COMPILE_STATUS)) return alert("Darn! An error occurred compiling the shaders:" + f.getShaderInfoLog(d)), null;
        var g = f.createProgram();
        return f.attachShader(g, c), f.attachShader(g, d), f.linkProgram(g), f.getProgramParameter(g, f.LINK_STATUS) || alert("Snap! Error linking shader program"), f.useProgram(g), g.vertexPositionAttribute = f.getAttribLocation(g, "position"), f.enableVertexAttribArray(g.vertexPositionAttribute), g.vertexNormalAttribute = f.getAttribLocation(g, "normal"), f.enableVertexAttribArray(g.vertexNormalAttribute), g.uPMatrixUniform = f.getUniformLocation(g, "transformMatrix"), g.uMVMatrixUniform = f.getUniformLocation(g, "modelviewMatrix"), g.uNMatrixUniform = f.getUniformLocation(g, "normalMatrix"), this.mHash[a + "|" + b] = g, g
      }, d.Renderer3D.prototype.saveShaders = function(a) {
        h.push(a)
      }, d.Renderer3D.prototype.emptyShaderStack = function() {
        h = []
      }, d.Renderer3D.prototype.getCurShaderKey = function() {
        var a = h[h.length - 1];
        return void 0 === a && (a = "normalVert|normalFrag", this.initShaders("normalVert", "normalFrag"), this.saveShaders(a)), a
        ...
        this.gHash[a] = {}, this.gHash[a].len = b.len, this.gHash[a].vertexBuffer = f.createBuffer(), this.gHash[a].normalBuffer = f.createBuffer(), this.gHash[a].indexBuffer = f.createBuffer();
        var c = this.mHash[this.getCurShaderKey()];
        f.bindBuffer(f.ARRAY_BUFFER, this.gHash[a].vertexBuffer), f.bufferData(f.ARRAY_BUFFER, new Float32Array(b.vertices), f.STATIC_DRAW), f.vertexAttribPointer(c.vertexPositionAttribute, 3, f.FLOAT, !1, 0, 0), f.bindBuffer(f.ARRAY_BUFFER, this.gHash[a].normalBuffer), f.bufferData(f.ARRAY_BUFFER, new Float32Array(b.vertexNormals), f.STATIC_DRAW), f.vertexAttribPointer(c.vertexNormalAttribute, 3, f.FLOAT, !1, 0, 0), f.bindBuffer(f.ELEMENT_ARRAY_BUFFER, this.gHash[a].indexBuffer), f.bufferData(f.ELEMENT_ARRAY_BUFFER, new Uint16Array(b.faces), f.STATIC_DRAW)
      }, d.Renderer3D.prototype.drawBuffer = function(a) {
        var b = this.getCurShaderKey(),
          c = this.mHash[b];
        f.bindBuffer(f.ARRAY_BUFFER, this.gHash[a].vertexBuffer), f.vertexAttribPointer(c.vertexPositionAttribute, 3, f.FLOAT, !1, 0, 0), f.bindBuffer(f.ARRAY_BUFFER, this.gHash[a].normalBuffer), f.vertexAttribPointer(c.vertexNormalAttribute, 3, f.FLOAT, !1, 0, 0), f.bindBuffer(f.ELEMENT_ARRAY_BUFFER, this.gHash[a].indexBuffer), this.setMatrixUniforms(b), f.drawElements(f.TRIANGLES, this.gHash[a].len, f.UNSIGNED_SHORT, 0)
      }, d.Renderer3D.prototype.setMatrixUniforms = function(a) {
        var b = this.mHash[a];
        f.useProgram(b), f.uniformMatrix4fv(b.uPMatrixUniform, !1, this.uPMatrix.mat4), f.uniformMatrix4fv(b.uMVMatrixUniform, !1, this.uMVMatrix.mat4), this.uNMatrix = new d.Matrix, this.uNMatrix.invert(this.uMVMatrix), this.uNMatrix.transpose(this.uNMatrix), f.uniformMatrix4fv(b.uNMatrixUniform, !1, this.uNMatrix.mat4)
        ...
        return a /= 100, b = -b / 100, c /= 100, this.uMVMatrix.translate([a, b, c]), this
        ...
        g.push(this.uMVMatrix.copy())
      }, d.Renderer3D.prototype.pop = function() {
        if (0 === g.length) throw "Invalid popMatrix!";
        this.uMVMatrix = g.pop()
      }, d.prototype.orbitControl = function() {
        return this.mouseIsPressed && (this.rotateX((this.mouseX - this.width / 2) / (this.width / 2)), this.rotateY((this.mouseY - this.height / 2) / (this.width / 2))), this
    ...
    9: [function(a, b, c) {
      var d = a("../core/core");
      d.ColorUtils = {}, d.ColorUtils.hsbaToRGBA = function(a, b) {
        var c = a[0],
          d = a[1],
          e = a[2],
          f = a[3] || b[3];
        c /= b[0], d /= b[1], e /= b[2], f /= b[3];
        var g = [];
        if (0 === d) g = [Math.round(255 * e), Math.round(255 * e), Math.round(255 * e), 255 * f];
        else {
          var h = 6 * c;
          6 === h && (h = 0);
          var i, j, k, l = Math.floor(h),
            m = e * (1 - d),
            n = e * (1 - d * (h - l)),
            o = e * (1 - d * (1 - (h - l)));
          0 === l ? (i = e, j = o, k = m) : 1 === l ? (i = n, j = e, k = m) : 2 === l ? (i = m, j = e, k = o) : 3 === l ? (i = m, j = n, k = e) : 4 === l ? (i = o, j = m, k = e) : (i = e, j = m, k = n), g = [Math.round(255 * i), Math.round(255 * j), Math.round(255 * k), 255 * f]
        }
        return g
      }, d.ColorUtils.rgbaToHSBA = function(a, b) {
        var c, d, e = a[0] / b[0],
          f = a[1] / b[1],
          g = a[2] / b[2],
          h = a[3] / b[3],
        ...
        if (0 === k) c = 0, d = 0;
          ...
          var m = ((j - e) / 6 + k / 2) / k,
            n = ((j - f) / 6 + k / 2) / k,
            o = ((j - g) / 6 + k / 2) / k;
          e === j ? c = o - n : f === j ? c = 1 / 3 + m - o : g === j && (c = 2 / 3 + n - m), 0 > c && (c += 1), c > 1 && (c -= 1)
        }
        return [Math.round(360 * c), Math.round(100 * d), Math.round(100 * l), 1 * h]
      }, d.ColorUtils.hslaToRGBA = function(a, b) {
        var c = a[0],
          d = a[1],
          e = a[2],
          f = a[3] || b[3];
        c /= b[0], d /= b[1], e /= b[2], f /= b[3];
        var g = [];
        if (0 === d) g = [Math.round(255 * e), Math.round(255 * e), Math.round(255 * e), f];
        else {
          var h, i, j, k, l;
          i = .5 > e ? e * (1 + d) : e + d - d * e, h = 2 * e - i;
          var m = function(a, b, c) {
            return 0 > c ? c += 1 : c > 1 && (c -= 1), 1 > 6 * c ? a + 6 * (b - a) * c : 1 > 2 * c ? b : 2 > 3 * c ? a + (b - a) * (2 / 3 - c) * 6 : a
          };
          j = m(h, i, c + 1 / 3), k = m(h, i, c), l = m(h, i, c - 1 / 3), g = [Math.round(255 * j), Math.round(255 * k), Math.round(255 * l), Math.round(255 * f)]
        }
        return g
      }, d.ColorUtils.rgbaToHSLA = function(a, b) {
        var c, d, e, f, g, h = a[0] / b[0],
          i = a[1] / b[1],
          j = a[2] / b[2],
          k = a[3] / b[3],
          l = Math.min(h, i, j),
          ...
          n = m - l,
          o = (m + l) / 2;
        return 0 === n ? (c = 0, d = 0) : (e = ((m - h) / 6 + n / 2) / n, f = ((m - i) / 6 + n / 2) / n, g = ((m - j) / 6 + n / 2) / n, h === m ? c = g - f : i === m ? c = 1 / 3 + e - g : j === m && (c = 2 / 3 + f - e), 0 > c && (c += 1), c > 1 && (c -= 1), d = .5 > o ? n / (m + l) : n / (2 - m - l)), [Math.round(360 * c), Math.round(100 * d), Math.round(100 * o), 1 * k]
    ...
    10: [function(a, b, c) {
      ...
      a("./p5.Color"), d.prototype.alpha = function(a) {
        ...
        if (arguments[0] instanceof d.Color) return arguments[0];
        if (arguments[0] instanceof Array) return new d.Color(this, arguments[0]);
        ...
        if (c = Math.max(Math.min(c, 1), 0), a instanceof Array) {
          for (var e = [], f = 0; f < a.length; f++) e.push(Math.sqrt(d.prototype.lerp(a[f] * a[f], b[f] * b[f], c)));
          return e
        }
        if (a instanceof d.Color) {
          for (var g = [], h = 0; 4 > h; h++) g.push(Math.sqrt(d.prototype.lerp(a.rgba[h] * a.rgba[h], b.rgba[h] * b.rgba[h], c)));
          return new d.Color(this, g)
        }
        return Math.sqrt(d.prototype.lerp(a * a, b * b, c))
    ...
    11: [function(a, b, c) {
      ...
      d.Color = function(a, b) {
        this.maxArr = a._colorMaxes[a._colorMode], this.color_array = d.Color._getFormattedColor.apply(a, b);
        var c = a._colorMode === f.HSB,
          g = a._colorMode === f.RGB,
          h = a._colorMode === f.HSL;
        if (g) this.rgba = this.color_array;
        else if (h) this.hsla = this.color_array, this.rgba = e.hslaToRGBA(this.color_array, this.maxArr);
        else {
          if (!c) throw new Error(a._colorMode + "is an invalid colorMode.");
          this.hsba = this.color_array, this.rgba = e.hsbaToRGBA(this.color_array, this.maxArr)
        }
        return this
      }, d.Color.prototype.getHue = function() {
        return this.hsla || this.hsba ? this.hsla ? this.hsla[0] : this.hsba[0] : (this.hsla = e.rgbaToHSLA(this.color_array, this.maxArr), this.hsla[0])
      }, d.Color.prototype.getSaturation = function() {
        return this.hsla ? this.hsla[1] : this.hsba ? this.hsba[1] : (this.hsla = e.rgbaToHSLA(this.color_array, this.maxArr), this.hsla[1])
      }, d.Color.prototype.getBrightness = function() {
        return this.hsba ? this.hsba[2] : (this.hsba = e.rgbaToHSBA(this.color_array, this.maxArr), this.hsba[2])
      }, d.Color.prototype.getLightness = function() {
        return this.hsla ? this.hsla[2] : (this.hsla = e.rgbaToHSLA(this.color_array, this.maxArr), this.hsla[2])
        ...
        return this.hsba || this.hsla ? this.hsla ? this.hsla[3] : this.hsba[3] : this.rgba[3]
      ...
      d.Color._getFormattedColor = function() {
        var a, b, c, e, g, h, i = arguments.length,
          j = this._colorMode;
        if (i >= 3) a = arguments[0], b = arguments[1], c = arguments[2], e = "number" == typeof arguments[3] ? arguments[3] : this._colorMaxes[j][3];
        else {
          if (1 === i && "string" == typeof arguments[0]) return g = arguments[0].trim().toLowerCase(), k[g] ? d.Color._getFormattedColor.apply(this, [k[g]]) : (h = l.HEX3.test(g) ? l.HEX3.exec(g).slice(1).map(function(a) {
            return parseInt(a + a, 16)
          }) : l.HEX6.test(g) ? l.HEX6.exec(g).slice(1).map(function(a) {
            return parseInt(a, 16)
          }) : l.RGB.test(g) ? l.RGB.exec(g).slice(1).map(function(a) {
            return parseInt(a, 10)
          }) : l.RGB_PERCENT.test(g) ? l.RGB_PERCENT.exec(g).slice(1).map(function(a) {
            return parseInt(parseFloat(a) / 100 * 255, 10)
          }) : l.RGBA.test(g) ? l.RGBA.exec(g).slice(1).map(function(a, b) {
            return 3 === b ? parseInt(255 * parseFloat(a), 10) : parseInt(a, 10)
          }) : l.RGBA_PERCENT.test(g) ? l.RGBA_PERCENT.exec(g).slice(1).map(function(a, b) {
            return 3 === b ? parseInt(255 * parseFloat(a), 10) : parseInt(parseFloat(a) / 100 * 255, 10)
          }) : l.HSL.test(g) ? l.HSL.exec(g).slice(1).map(function(a) {
            return parseInt(a, 10)
          }) : l.HSLA.test(g) ? l.HSLA.exec(g).slice(1).map(function(a) {
            return parseFloat(a, 10)
          }) : [255], d.Color._getFormattedColor.apply(this, h));
          if (1 === i && "number" == typeof arguments[0]) j === f.RGB ? a = b = c = arguments[0] : (j === f.HSB || j === f.HSL) && (a = c = arguments[0], b = 0), e = "number" == typeof arguments[1] ? arguments[1] : this._colorMaxes[j][3];
          else {
            if (2 !== i || "number" != typeof arguments[0] || "number" != typeof arguments[1]) throw new Error(arguments + "is not a valid color representation.");
            j === f.RGB ? a = b = c = arguments[0] : (j === f.HSB || j === f.HSL) && (a = c = arguments[0], b = 0), e = arguments[1]
          }
        }
        return [a, b, c, e]
      }, b.exports = d.Color
    ...
    12: [function(a, b, c) {
      ...
      var d = a("../core/core"),
        e = a("../core/constants");
      a("./p5.Color"), d.prototype._doStroke = !0, d.prototype._doFill = !0, d.prototype._strokeSet = !1, d.prototype._fillSet = !1, d.prototype._colorMode = e.RGB, d.prototype._colorMaxes = {
        rgb: [255, 255, 255, 255],
        hsb: [360, 100, 100, 1],
        hsl: [360, 100, 100, 1]
      }, d.prototype.background = function() {
        return arguments[0] instanceof d.Image ? this.image(arguments[0], 0, 0, this.width, this.height) : this._graphics.background.apply(this._graphics, arguments), this
      }, d.prototype.clear = function() {
        return this._graphics.clear(), this
      }, d.prototype.colorMode = function() {
        if (arguments[0] === e.RGB || arguments[0] === e.HSB || arguments[0] === e.HSL) {
          this._colorMode = arguments[0];
          var a = this._colorMaxes[this._colorMode];
          2 === arguments.length ? (a[0] = arguments[1], a[1] = arguments[1], a[2] = arguments[1], a[3] = arguments[1]) : arguments.length > 2 && (a[0] = arguments[1], a[1] = arguments[2], a[2] = arguments[3]), 5 === arguments.length && (a[3] = arguments[4])
        }
        return this
      }, d.prototype.fill = function() {
        return this._setProperty("_fillSet", !0), this._setProperty("_doFill", !0), this._graphics.fill.apply(this._graphics, arguments), this
      }, d.prototype.noFill = function() {
        return this._setProperty("_doFill", !1), this
      }, d.prototype.noStroke = function() {
        return this._setProperty("_doStroke", !1), this
      }, d.prototype.stroke = function() {
        return this._setProperty("_strokeSet", !0), this._setProperty("_doStroke", !0), this._graphics.stroke.apply(this._graphics, arguments), this
      }, b.exports = d
    }, {
      "../core/constants": 16,
      "../core/core": 17,
    ...
    13: [function(a, b, c) {
      ...
      a("./error_helpers"), d.prototype.arc = function(a, b, c, d, f, g, h) {
        if (this._validateParameters("arc", arguments, [
            ["Number", "Number", "Number", "Number", "Number", "Number"],
            ["Number", "Number", "Number", "Number", "Number", "Number", "String"]
          ]), !this._doStroke && !this._doFill) return this;
        ...
        return this._validateParameters("ellipse", arguments, ["Number", "Number", "Number", "Number"]), this._doStroke || this._doFill ? (c = Math.abs(c), d = Math.abs(d), this._graphics.ellipse(a, b, c, d), this) : this
      }, d.prototype.line = function() {
        return this._validateParameters("line", arguments, [
          ["Number", "Number", "Number", "Number"],
          ["Number", "Number", "Number", "Number", "Number", "Number"]
        ]), this._doStroke ? void(this._graphics.isP3D ? this._graphics.line(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]) : this._graphics.line(arguments[0], arguments[1], arguments[2], arguments[3])) : this
      }, d.prototype.point = function(a, b) {
        return this._validateParameters("point", arguments, ["Number", "Number"]), this._doStroke ? (this._graphics.point(a, b), this) : this
      }, d.prototype.quad = function(a, b, c, d, e, f, g, h) {
        return this._validateParameters("quad", arguments, ["Number", "Number", "Number", "Number", "Number", "Number", "Number", "Number"]), this._doStroke || this._doFill ? (this._graphics.quad(a, b, c, d, e, f, g, h), this) : this
      }, d.prototype.rect = function(a, b, c, d, e, f, g, h) {
        return this._validateParameters("rect", arguments, [
          ["Number", "Number", "Number", "Number"],
          ["Number", "Number", "Number", "Number", "Number"],
          ["Number", "Number", "Number", "Number", "Number", "Number", "Number", "Number", "Number"]
        ]), this._doStroke || this._doFill ? (this._graphics.rect(a, b, c, d, e, f, g, h), this) : void 0
      }, d.prototype.triangle = function(a, b, c, d, e, f) {
        return this._validateParameters("triangle", arguments, ["Number", "Number", "Number", "Number", "Number", "Number"]), this._doStroke || this._doFill ? (this._graphics.triangle(a, b, c, d, e, f), this) : this
      }, b.exports = d
    }, {
      "./constants": 16,
      "./core": 17,
    ...
    14: [function(a, b, c) {
      ...
      var d = a("./core"),
        e = a("./constants");
      d.prototype._rectMode = e.CORNER, d.prototype._ellipseMode = e.CENTER, d.prototype.ellipseMode = function(a) {
        return (a === e.CORNER || a === e.CORNERS || a === e.RADIUS || a === e.CENTER) && (this._ellipseMode = a), this
      }, d.prototype.noSmooth = function() {
        return this._graphics.noSmooth(), this
      }, d.prototype.rectMode = function(a) {
        return (a === e.CORNER || a === e.CORNERS || a === e.RADIUS || a === e.CENTER) && (this._rectMode = a), this
      }, d.prototype.smooth = function() {
        return this._graphics.smooth(), this
      }, d.prototype.strokeCap = function(a) {
        return (a === e.ROUND || a === e.SQUARE || a === e.PROJECT) && this._graphics.strokeCap(a), this
      }, d.prototype.strokeJoin = function(a) {
        return (a === e.ROUND || a === e.BEVEL || a === e.MITER) && this._graphics.strokeJoin(a), this
      }, d.prototype.strokeWeight = function(a) {
        return this._graphics.strokeWeight(a), this
      }, b.exports = d
    }, {
      "./constants": 16,
      "./core": 17
    ...
    17: [function(a, b, c) {
      ...
      var d = a("./constants"),
        e = function(a, b, c) {
          2 === arguments.length && "boolean" == typeof b && (c = b, b = void 0), this._setupDone = !1, this.pixelDensity = window.devicePixelRatio || 1, this._userNode = b, this._curElement = null, this._elements = [], this._preloadCount = 0, this._updateInterval = 0, this._isGlobal = !1, this._loop = !0, this._styles = [], this._defaultCanvasSize = {
            width: 100,
            height: 100
          }, this._events = {
            mousemove: null,
            ...
            if (b) {
              ...
              Object.keys(d).forEach(function(a) {
                c[a] = function() {
                  ...
                  return c._preload(a, d[a], b)
                }
              }), b(), 0 === this._preloadCount && (this._setup(), this._runFrames(), this._draw())
            } else this._setup(), this._runFrames(), this._draw()
          }.bind(this), this._preload = function(a, b, c) {
            var d = this._isGlobal ? window : this;
            d._setProperty("_preloadCount", d._preloadCount + 1);
            var e = function(a) {
              d._setProperty("_preloadCount", d._preloadCount - 1), 0 === d._preloadCount && (d._setup(), d._runFrames(), d._draw())
            };
            return c.push(e), window[b].prototype[a].apply(d, c)
            ...
            if ("function" == typeof a.preload)
              for (var b in this._preloadMethods) {
                var c = this._preloadMethods[b];
                a[b] = window[c].prototype[b]
              }
            "function" == typeof a.setup && a.setup();
            for (var d = new RegExp(/(^|\s)p5_hidden(?!\S)/g), e = document.getElementsByClassName("p5_hidden"), f = 0; f < e.length; f++) {
              var g = e[f];
              g.style.visibility = "", g.className = g.className.replace(d, "")
            }
            this._setupDone = !0, this._loadingScreen.parentNode.removeChild(this._loadingScreen)
          }.bind(this), this._draw = function() {
            var a = window.performance.now(),
              b = a - this._lastFrameTime,
              c = 1e3 / this._targetFrameRate,
              d = 5;
            (!this.loop || b >= c - d) && (this._setProperty("frameCount", this.frameCount + 1), this.redraw(), this._updatePAccelerations(), this._updatePMouseCoords(), this._updatePTouchCoords(), this._frameRate = 1e3 / (a - this._lastFrameTime), this._lastFrameTime = a), this._loop && window.requestAnimationFrame(this._draw)
            ...
            if (this._curElement) {
              this._loop = !1, this._updateInterval && clearTimeout(this._updateInterval);
      ...
      e.prototype._preloadMethods = {
        ...
        b = b || "p5", e.prototype._preloadMethods.hasOwnProperty(a) || (e.prototype._preloadMethods[a] = b)
    ...
    18: [function(a, b, c) {
      ...
      var e = 20,
        f = 20;
      d.prototype._curveTightness = 0, d.prototype.bezier = function(a, b, c, d, e, f, g, h) {
        return this._validateParameters("bezier", arguments, ["Number", "Number", "Number", "Number", "Number", "Number", "Number", "Number"]), this._doStroke ? (this._graphics.bezier(a, b, c, d, e, f, g, h), this) : this
        ...
        return this._validateParameters("curve", arguments, ["Number", "Number", "Number", "Number", "Number", "Number", "Number", "Number"]), this._doStroke ? (this._graphics.curve(a, b, c, d, e, f, g, h), this) : void 0
    ...
    20: [function(a, b, c) {
      ...
      for (var g = a("./core"), h = !0, i = {}, j = i.toString, k = ["Boolean", "Number", "String", "Function", "Array", "Date", "RegExp", "Object", "Error"], l = 0; l < k.length; l++) i["[object " + k[l] + "]"] = k[l].toLowerCase();
      var m = function(a) {
      ...
      g.prototype._validateParameters = function(a, b, c) {
        ...
        var l = "X";
        g > 0 && (f = "You wrote " + a + "(", b.length > 0 && (f += l + ("," + l).repeat(b.length - 1)), f += "). " + a + " was expecting " + c[h].length + " parameters. Try " + a + "(", c[h].length > 0 && (f += l + ("," + l).repeat(c[h].length - 1)), f += ").", c.length > 1 && (f += " " + a + " takes different numbers of parameters depending on what you want to do. Click this link to learn more: "), e(f, a, q));
    ...
    21: [function(a, b, c) {
      ...
      e.Element = function(a, b) {
        ...
        return "string" == typeof a ? a = document.getElementById(a) : a instanceof e.Element && (a = a.elt), a.appendChild(this.elt), this
        ...
        return window.File && window.FileReader && window.FileList && window.Blob ? (d("dragover", function(a) {
          ...
          for (var b = a.dataTransfer.files, d = 0; d < b.length; d++) {
            var e = b[d],
              f = new FileReader;
            f.onload = c(e), "text" === e.type ? f.readAsText(e) : f.readAsDataURL(e)
          }
    ...
    22: [function(a, b, c) {
      ...
      d.Graphics = function(a, b, c, f) {
        ...
        i.appendChild(h), d.Element.call(this, h, f, !1), this._styles = [], this.width = a, this.height = b, this.pixelDensity = f.pixelDensity, g === e.WEBGL ? this._graphics = new d.Renderer3D(h, this, !1) : this._graphics = new d.Renderer2D(h, this, !1), this._graphics.resize(a, b), this._graphics._applyDefaults(), f._elements.push(this);
    ...
    23: [function(a, b, c) {
      var d = a("./core");
      d.Renderer = function(a, b, c) {
        d.Element.call(this, a, b), this.canvas = a, this._pInst = b, c ? (this._isMainCanvas = !0, this._pInst._setProperty("_curElement", this), this._pInst._setProperty("canvas", this.canvas), this._pInst._setProperty("width", this.width), this._pInst._setProperty("height", this.height)) : (this.canvas.style.display = "none", this._styles = [])
      }, d.Renderer.prototype = Object.create(d.Element.prototype), d.Renderer.prototype.resize = function(a, b) {
    ...
    24: [function(a, b, c) {
      ...
      d.Renderer2D = function(a, b, c) {
      ...
      }, d.Renderer2D.prototype.image = function(a, b, c, d, e) {
        var f = a.canvas || a.elt;
        try {
          this._pInst._tint && a.canvas ? this.drawingContext.drawImage(this._getTintedImageCanvas(a), b, c, d, e) : this.drawingContext.drawImage(f, b, c, d, e)
        } catch (g) {
          if ("NS_ERROR_NOT_AVAILABLE" !== g.name) throw g
        }
        ...
        for (var d = c.getContext("2d"), e = d.createImageData(a.canvas.width, a.canvas.height), f = e.data, h = 0; h < b.length; h += 4) {
          var i = b[h],
            ...
            k = b[h + 2],
            l = b[h + 3];
          f[h] = i * this._pInst._tint[0] / 255, f[h + 1] = j * this._pInst._tint[1] / 255, f[h + 2] = k * this._pInst._tint[2] / 255, f[h + 3] = l * this._pInst._tint[3] / 255
        }
        ...
        var f = this.pixelDensity || this._pInst.pixelDensity;
        if (1 === c && 1 === e) {
          for (var g = this.drawingContext.getImageData(a * f, b * f, c, e), h = g.data, i = [], j = 0; j < h.length; j += 4) i.push(h[j], h[j + 1], h[j + 2], h[j + 3]);
          return i
        }
        var k = a * f,
          l = b * f,
          m = Math.min(c, this.width),
          n = Math.min(e, this.height),
          o = m * f,
          p = n * f,
          q = new d.Image(m, n);
        return q.canvas.getContext("2d").drawImage(this.canvas, k, l, o, p, 0, 0, m, n), q
        ...
        if (c instanceof d.Image) this.drawingContext.save(), this.drawingContext.setTransform(1, 0, 0, 1, 0, 0), this.drawingContext.scale(e), this.drawingContext.drawImage(c.canvas, a, b), this.loadPixels.call(this._pInst), this.drawingContext.restore();
        else {
          var f = this._pInst || this,
            ...
            i = 0,
            j = 0,
            k = 4 * (b * f.pixelDensity * this.width * f.pixelDensity + a * f.pixelDensity);
          if (f.imageData || f.loadPixels.call(f), "number" == typeof c) k < f.pixels.length && (g = c, h = c, i = c, j = 255);
          else if (c instanceof Array) {
            if (c.length < 4) throw new Error("pixel array must be of the form [R, G, B, A]");
            k < f.pixels.length && (g = c[0], h = c[1], i = c[2], j = c[3])
          } else c instanceof d.Color && k < f.pixels.length && (g = c.rgba[0], h = c.rgba[1], i = c.rgba[2], j = c.rgba[3]);
          for (var l = 0; l < f.pixelDensity; l++)
            for (var m = 0; m < f.pixelDensity; m++) k = 4 * ((b * f.pixelDensity + m) * this.width * f.pixelDensity + (a * f.pixelDensity + l)), f.pixels[k] = g, f.pixels[k + 1] = h, f.pixels[k + 2] = i, f.pixels[k + 3] = j
        }
        ...
        for (var j = this.drawingContext, k = e.arcModeAdjust(a, b, c, d, this._pInst._ellipseMode), l = k.w / 2, m = k.h / 2, n = 1e-5, o = 0, p = []; h - g > n;) o = Math.min(h - g, f.HALF_PI), p.push(this._acuteArcToBezier(g, o)), g += o;
        return this._pInst._doFill && (j.beginPath(), p.forEach(function(a, b) {
          0 === b && j.moveTo(k.x + a.ax * l, k.y + a.ay * m), j.bezierCurveTo(k.x + a.bx * l, k.y + a.by * m, k.x + a.cx * l, k.y + a.cy * m, k.x + a.dx * l, k.y + a.dy * m)
        }), (i === f.PIE || null == i) && j.lineTo(k.x, k.y), j.closePath(), j.fill()), this._pInst._doStroke && (j.beginPath(), p.forEach(function(a, b) {
          0 === b && j.moveTo(k.x + a.ax * l, k.y + a.ay * m), j.bezierCurveTo(k.x + a.bx * l, k.y + a.by * m, k.x + a.cx * l, k.y + a.cy * m, k.x + a.dx * l, k.y + a.dy * m)
        ...
        var f = this.drawingContext,
          g = this._pInst._doFill,
          i = this._pInst._doStroke;
        if (g && !i) {
          if (f.fillStyle === h) return this
        } else if (!g && i && f.strokeStyle === h) return this;
        var j = e.modeAdjust(a, b, c, d, this._pInst._ellipseMode),
          k = .5522847498,
          l = j.w / 2 * k,
          m = j.h / 2 * k,
          n = j.x + j.w,
        ...
        return this._pInst._doStroke ? e.strokeStyle === h ? this : (e.lineWidth % 2 === 1 && e.translate(.5, .5), e.beginPath(), e.moveTo(a, b), e.lineTo(c, d), e.stroke(), e.lineWidth % 2 === 1 && e.translate(-.5, -.5), this) : this
      }, d.Renderer2D.prototype.point = function(a, b) {
        var c = this.drawingContext,
          d = c.strokeStyle,
          e = c.fillStyle;
        return this._pInst._doStroke ? c.strokeStyle === h ? this : (a = Math.round(a), b = Math.round(b), c.fillStyle = d, c.lineWidth > 1 ? (c.beginPath(), c.arc(a, b, c.lineWidth / 2, 0, f.TWO_PI, !1), c.fill()) : c.fillRect(a, b, 1, 1), void(c.fillStyle = e)) : this
      }, d.Renderer2D.prototype.quad = function(a, b, c, d, e, f, g, i) {
        var j = this.drawingContext,
          k = this._pInst._doFill,
          l = this._pInst._doStroke;
        if (k && !l) {
        ...
        var k = this.drawingContext,
          l = this._pInst._doFill,
          m = this._pInst._doStroke;
        if (l && !m) {
          if (k.fillStyle === h) return this
        } else if (!l && m && k.strokeStyle === h) return this;
        var n = e.modeAdjust(a, b, c, d, this._pInst._rectMode);
        if (this._pInst._doStroke && k.lineWidth % 2 === 1 && k.translate(.5, .5), k.beginPath(), "undefined" == typeof f) k.rect(n.x, n.y, n.w, n.h);
        else {
        ...
        return this._pInst._doFill && k.fill(), this._pInst._doStroke && k.stroke(), this._pInst._doStroke && k.lineWidth % 2 === 1 && k.translate(-.5, -.5), this
      }, d.Renderer2D.prototype.triangle = function(a, b, c, d, e, f) {
        var g = this.drawingContext,
          i = this._pInst._doFill,
          j = this._pInst._doStroke;
        if (i && !j) {
        ...
        if (!this._pInst._doStroke && !this._pInst._doFill) return this;
        var i, j = a === f.CLOSE;
        j && !g && b.push(b[0]);
        var k, l, m = b.length;
        if (!c || h !== f.POLYGON && null !== h)
          if (!d || h !== f.POLYGON && null !== h)
            if (!e || h !== f.POLYGON && null !== h)
              if (h === f.POINTS)
                for (k = 0; m > k; k++) i = b[k], this._pInst._doStroke && this._pInst.stroke(i[6]), this._pInst.point(i[0], i[1]);
              else if (h === f.LINES)
          for (k = 0; m > k + 1; k += 2) i = b[k], this._pInst._doStroke && this._pInst.stroke(b[k + 1][6]), this._pInst.line(i[0], i[1], b[k + 1][0], b[k + 1][1]);
        else if (h === f.TRIANGLES)
          for (k = 0; m > k + 2; k += 3) i = b[k], this.drawingContext.beginPath(), this.drawingContext.moveTo(i[0], i[1]), this.drawingContext.lineTo(b[k + 1][0], b[k + 1][1]), this.drawingContext.lineTo(b[k + 2][0], b[k + 2][1]), this.drawingContext.lineTo(i[0], i[1]), this._pInst._doFill && (this._pInst.fill(b[k + 2][5]), this.drawingContext.fill()), this._pInst._doStroke && (this._pInst.stroke(b[k + 2][6]), this.drawingContext.stroke()), this.drawingContext.closePath();
          ...
          for (k = 0; m > k + 3; k += 4) {
            ...
            this.drawingContext.lineTo(i[0], i[1]), this._pInst._doFill && this._pInst.fill(b[k + 3][5]), this._pInst._doStroke && this._pInst.stroke(b[k + 3][6]), this._doFillStrokeClose()
          ...
          var n = [],
            o = 1 - this._pInst._curveTightness;
        ...
        this._pInst._doFill && this.drawingContext.fill(), this._pInst._doStroke && this.drawingContext.stroke(), this.drawingContext.closePath()
      ...
      }, d.Renderer2D.prototype.scale = function() {
        var a = 1,
          b = 1;
        ...
        if (q._doFill || q._doStroke) {
          if ("string" != typeof a && (a = a.toString()), a = a.replace(/(\t)/g, "  "), g = a.split("\n"), "undefined" != typeof d) {
            ...
            switch (this._pInst._rectMode === f.CENTER && (b -= d / 2, c -= e / 2), this.drawingContext.textAlign) {
              case f.CENTER:
                b += d / 2;
                break;
              case f.RIGHT:
            ...
            if ("undefined" != typeof e) switch (this.drawingContext.textBaseline) {
              case f.BOTTOM:
                c += e - o;
                break;
              case f._CTX_MIDDLE:
            ...
            for (i = 0; i < g.length; i++) {
              for (k = "", n = g[i].split(" "), h = 0; h < n.length; h++) l = k + n[h] + " ", m = this.textWidth(l), m > d && k.length > 0 ? (this._renderText(q, k, b, c), k = n[h] + " ", c += q.textLeading()) : k = l;
              this._renderText(q, k, b, c), c += q.textLeading()
            }
          } else
            for (j = 0; j < g.length; j++) this._renderText(q, g[j], b, c), c += q.textLeading();
          return p && (this.drawingContext.textBaseline = f.BASELINE), q
        }
      }, d.Renderer2D.prototype._renderText = function(a, b, c, d) {
        return a.push(), a._isOpenType() ? a._textFont._renderPath(b, c, d) : (a._doStroke && a._strokeSet && this.drawingContext.strokeText(b, c, d), a._doFill && (this.drawingContext.fillStyle = a._fillSet ? this.drawingContext.fillStyle : f._DEFAULT_TEXT_FILL, this.drawingContext.fillText(b, c, d))), a.pop(), a
      }, d.Renderer2D.prototype.textWidth = function(a) {
        return this._pInst._isOpenType() ? this._pInst._textFont._textWidth(a) : this.drawingContext.measureText(a).width
        ...
        var a, b = this._pInst;
        return b._setProperty("_textAscent", null), b._setProperty("_textDescent", null), a = b._textFont, b._isOpenType() && (a = b._textFont.font.familyName, b._setProperty("_textStyle", b._textFont.font.styleName)), this.drawingContext.font = b._textStyle + " " + b._textSize + "px " + a, b
    ...
    25: [function(a, b, c) {
      var d = a("./core"),
        e = a("./constants");
      a("./p5.Graphics"), a("./p5.Renderer2D"), a("../3d/p5.Renderer3D"), d.prototype.createCanvas = function(a, b, c) {
        var f, g, h = c || e.P2D;
        return arguments[3] && (f = "boolean" == typeof arguments[3] ? arguments[3] : !1), h === e.WEBGL ? (g = document.getElementById("defaultCanvas"), g && g.parentNode.removeChild(g), g = document.createElement("canvas"), g.id = "defaultCanvas") : f ? (g = document.createElement("canvas"), g.id = "defaultCanvas") : g = this.canvas, this._setupDone || (g.className += " p5_hidden", g.style.visibility = "hidden"), this._userNode ? this._userNode.appendChild(g) : document.body.appendChild(g), h === e.WEBGL ? (this._setProperty("_graphics", new d.Renderer3D(g, this, !0)), this._isdefaultGraphics = !0) : this._isdefaultGraphics || (this._setProperty("_graphics", new d.Renderer2D(g, this, !0)), this._isdefaultGraphics = !0), this._graphics.resize(a, b), this._graphics._applyDefaults(), this._graphics
      }, d.prototype.resizeCanvas = function(a, b, c) {
        this._graphics && (this._graphics.resize(a, b), this._graphics._applyDefaults(), c || this.redraw())
    ...
    27: [function(a, b, c) {
      ...
      d.prototype.exit = function() {
        ...
        this._graphics.push(), this._styles.push({
        ...
        "function" == typeof b && (this.push(), "undefined" == typeof a && this.scale(this.pixelDensity, this.pixelDensity), this._registeredMethods.pre.forEach(function(a) {
          a.call(this)
    ...
    28: [function(a, b, c) {
      ...
      d.prototype.applyMatrix = function(a, b, c, d, e, f) {
        return this._graphics.applyMatrix(a, b, c, d, e, f), this
        ...
        return this._graphics.resetMatrix(), this
      }, d.prototype.rotate = function(a) {
        return this._angleMode === e.DEGREES && (a = this.radians(a)), this._graphics.rotate(a), this
      }, d.prototype.rotateX = function(a) {
        if (!this._graphics.isP3D) throw "not yet implemented.";
        return this._graphics.rotateX(a), this
      }, d.prototype.rotateY = function(a) {
        if (!this._graphics.isP3D) throw "not yet implemented.";
        return this._graphics.rotateY(a), this
      }, d.prototype.rotateZ = function(a) {
        if (!this._graphics.isP3D) throw "not supported in p2d. Please use webgl mode";
        return this._graphics.rotateZ(a), this
      }, d.prototype.scale = function() {
        return this._graphics.isP3D ? this._graphics.scale(arguments[0], arguments[1], arguments[2]) : this._graphics.scale.apply(this._graphics, arguments), this
      }, d.prototype.shearX = function(a) {
        return this._angleMode === e.DEGREES && (a = this.radians(a)), this._graphics.shearX(a), this
      }, d.prototype.shearY = function(a) {
        return this._angleMode === e.DEGREES && (a = this.radians(a)), this._graphics.shearY(a), this
      }, d.prototype.translate = function(a, b, c) {
        return this._graphics.isP3D ? this._graphics.translate(a, b, c) : this._graphics.translate(a, b), this
      }, b.exports = d
    }, {
      "./constants": 16,
      "./core": 17
    ...
    29: [function(a, b, c) {
      ...
      d.prototype.beginContour = function() {
        ...
        return f = a === e.POINTS || a === e.LINES || a === e.TRIANGLES || a === e.TRIANGLE_FAN || a === e.TRIANGLE_STRIP || a === e.QUADS || a === e.QUAD_STRIP ? a : null, g = [], h = [], this
        ...
        var b = a === e.CLOSE;
        return b && !l && g.push(g[0]), this._graphics.endShape(a, g, j, i, k, l, f), j = !1, i = !1, k = !1, l = !1, b && g.pop(), this
        ...
        var d = [];
        return d.isVert = !0, d[0] = a, d[1] = b, d[2] = 0, d[3] = 0, d[4] = 0, d[5] = this._graphics._getFill(), d[6] = this._graphics._getStroke(), c && (d.moveTo = c), l ? (0 === h.length && (d.moveTo = !0), h.push(d)) : g.push(d), this
      }, b.exports = d
    }, {
      "./constants": 16,
      "./core": 17
    ...
    30: [function(a, b, c) {
      ...
      d.prototype._ondeviceorientation = function(a) {
        this._setProperty("accelerationX", a.beta), this._setProperty("accelerationY", a.gamma), this._setProperty("accelerationZ", a.alpha), this._handleMotion()
      ...
      }, d.prototype._onMozOrientation = function(a) {
        this._setProperty("accelerationX", a.x), this._setProperty("accelerationY", a.y), this._setProperty("accelerationZ", a.z), this._handleMotion()
        ...
        "function" == typeof a && (Math.abs(this.accelerationX - this.pAccelerationX) > e || Math.abs(this.accelerationY - this.pAccelerationY) > e || Math.abs(this.accelerationZ - this.pAccelerationZ) > e) && a();
        var b = this.deviceTurned || window.deviceTurned;
        if ("function" == typeof b) {
          var c = 0;
          Math.abs(this.accelerationX) > c && (c = this.accelerationX, g = "x"), Math.abs(this.accelerationY) > c && (c = this.accelerationY, g = "y"), Math.abs(this.accelerationZ) > c && (g = "z"), "" !== f && f !== g && b(g), f = g
        }
      }, b.exports = d
    }, {
      "../core/core": 17
    ...
    35: [function(a, b, c) {
      ...
      var d = a("../core/core"),
        e = a("../core/constants"),
        f = [];
      d.prototype._imageMode = e.CORNER, d.prototype._tint = null, d.prototype.createImage = function(a, b) {
      ...
      }, d.prototype.saveFrames = function(a, b, c, e, g) {
        var h = c || 3;
        ...
        if (b) switch (b.toLowerCase()) {
          ...
          default:
            e = "image/png"
        } else b = "png", e = "image/png";
        var g = "image/octet-stream",
          h = d.toDataURL(e);
        h = h.replace(e, g);
        var i = {};
        i.imageData = h, i.filename = a, i.ext = b, f.push(i)
      }, b.exports = d
    }, {
      "../core/constants": 16,
      "../core/core": 17
    ...
    36: [function(a, b, c) {
      ...
      var d = a("../core/core"),
        ...
        f = a("../core/canvas"),
        g = a("../core/constants");
      a("../core/error_helpers"), d.prototype.loadImage = function(a, b, c) {
        var e = new Image,
          f = new d.Image(1, 1, this);
        return e.onload = function() {
          f.width = f.canvas.width = e.width, f.height = f.canvas.height = e.height, f.canvas.getContext("2d").drawImage(e, 0, 0), "function" == typeof b && b(f)
        }, e.onerror = function(a) {
          d._friendlyFileLoadError(0, e.src), "function" == typeof c && c(a)
        }, 0 !== a.indexOf("data:image/") && (e.crossOrigin = "Anonymous"), e.src = a, f
      }, d.prototype.image = function(a, b, c, d, e) {
        b = b || 0, c = c || 0, d = d || a.width, e = e || a.height;
        var g = f.modeAdjust(b, c, d, e, this._imageMode);
        this._graphics.image(a, g.x, g.y, g.w, g.h)
      }, d.prototype.tint = function() {
        var a = this.color.apply(this, arguments);
        this._tint = a.rgba
      }, d.prototype.noTint = function() {
        this._tint = null
      }, d.prototype._getTintedImageCanvas = function(a) {
        if (!a.canvas) return a;
        var b = e._toPixels(a.canvas),
          c = document.createElement("canvas");
        c.width = a.canvas.width, c.height = a.canvas.height;
        for (var d = c.getContext("2d"), f = d.createImageData(a.canvas.width, a.canvas.height), g = f.data, h = 0; h < b.length; h += 4) {
          var i = b[h],
            j = b[h + 1],
            k = b[h + 2],
            l = b[h + 3];
      ...
      }, d.prototype.imageMode = function(a) {
        (a === g.CORNER || a === g.CORNERS || a === g.CENTER) && (this._imageMode = a)
      }, b.exports = d
    }, {
      "../core/canvas": 15,
      "../core/constants": 16,
    ...
    39: [function(a, b, c) {
      ...
      var h = a("../core/core"),
        i = a("reqwest");
      a("../core/error_helpers"), h.prototype.loadFont = function(a, b) {
        var c = new h.Font(this);
        return opentype.load(a, function(a, d) {
          if (a) throw Error(a);
          c.font = d, "undefined" != typeof b && b(c)
        }), c
        ...
        var a = arguments[0],
          ...
          c = [],
          d = "json";
        return "string" == typeof arguments[2] && ("jsonp" === arguments[2] || "json" === arguments[2]) && (d = arguments[2]), i({
          url: a,
          type: d,
          crossOrigin: !0
        }).then(function(a) {
        ...
        return i({
          ...
          a = a.responseText;
          for (var c, g = {}, i = 0, l = 1, m = 2, n = 4, o = '"', p = "\r", q = "\n", r = [], s = 0, t = null, u = function() {
              g.escaped = !1, t = [], w()
            }, v = function() {
              g.currentState = n, r.push(t), t = null
            }, w = function() {
            ...
            if (null === t && u(), g.currentState === i) {
              if (c === o) {
                g.escaped = !0, g.currentState = l;
                continue
              }
              g.currentState = l
            }
            g.currentState === l && g.escaped ? c === o ? a[s] === o ? (g.token += o, s++) : (g.escaped = !1, g.currentState = m) : g.token += c : c === p ? (a[s] === q && s++, x(), v()) : c === q ? (x(), v()) : c === f ? x() : g.currentState === l && (g.token += c)
          }
          if (e) k.columns = r.shift();
          else
            for (j = 0; j < r.length; j++) k.columns[j] = j.toString();
          var y;
          for (j = 0; j < r.length && (j !== r.length - 1 || 1 !== r[j].length || "undefined" !== r[j][0]); j++) y = new h.TableRow, y.arr = r[j], y.obj = d(r[j], k.columns), k.addRow(y);
          null !== b && b(k)
        }).fail(function(c, d) {
          h._friendlyFileLoadError(2, a), "undefined" != typeof b && b(!1)
        }), k
        ...
        return i({
          ...
          c.appendChild(d), "undefined" != typeof b && b(a)
        }), c
        ...
        if (d[0] instanceof h.Renderer) return void h.prototype.saveCanvas(d[0].elt, d[1], d[2]);
    ...
    44: [function(a, b, c) {
      "use strict";
      for (var d = a("../core/core"), e = 4, f = 1 << e, g = 8, h = 1 << g, i = 4095, j = 4, k = .5, l = .5, m = Math.floor(360 / l), n = new Array(m), o = new Array(m), p = Math.PI / 180, q = 0; m > q; q++) n[q] = Math.sin(q * p * l), o[q] = Math.cos(q * p * l);
      var r = m;
      r >>= 1;
      var s;
      d.prototype.noise = function(a, b, c) {
        if (b = b || 0, c = c || 0, null == s) {
          s = new Array(i + 1);
          for (var d = 0; i + 1 > d; d++) s[d] = Math.random()
        }
        0 > a && (a = -a), 0 > b && (b = -b), 0 > c && (c = -c);
        for (var l, n, p, q, t, u = Math.floor(a), v = Math.floor(b), w = Math.floor(c), x = a - u, y = b - v, z = c - w, A = 0, B = .5, C = function(a) {
            return .5 * (1 - o[Math.floor(a * r) % m])
          }, D = 0; j > D; D++) {
          var E = u + (v << e) + (w << g);
          l = C(x), n = C(y), p = s[E & i], p += l * (s[E + 1 & i] - p), q = s[E + f & i], q += l * (s[E + f + 1 & i] - q), p += n * (q - p), E += h, q = s[E & i], q += l * (s[E + 1 & i] - q), t = s[E + f & i], t += l * (s[E + f + 1 & i] - t), q += n * (t - q), p += C(z) * (q - p), A += p * B, B *= k, u <<= 1, x *= 2, v <<= 1, y *= 2, w <<= 1, z *= 2, x >= 1 && (u++, x--), y >= 1 && (v++, y--), z >= 1 && (w++, z--)
        }
        return A
      }, d.prototype.noiseDetail = function(a, b) {
        a > 0 && (j = a), b > 0 && (k = b)
      }, d.prototype.noiseSeed = function(a) {
        var b = function() {
        ...
        b.setSeed(a), s = new Array(i + 1);
        for (var c = 0; i + 1 > c; c++) s[c] = b.rand()
      }, b.exports = d
    }, {
      "../core/core": 17
    }],
    ...
    49: [function(a, b, c) {
      ...
      var d = a("../core/core"),
        e = a("../core/constants");
      d.prototype._textSize = 12, d.prototype._textLeading = 15, d.prototype._textFont = "sans-serif", d.prototype._textStyle = e.NORMAL, d.prototype._textAscent = null, d.prototype._textDescent = null, d.prototype.textAlign = function(a, b) {
        return this._graphics.textAlign(a, b)
      }, d.prototype.textLeading = function(a) {
        return arguments.length ? (this._setProperty("_textLeading", a), this) : this._textLeading
      }, d.prototype.textSize = function(a) {
        return arguments.length ? (this._setProperty("_textSize", a), this._setProperty("_textLeading", a * e._DEFAULT_LEADMULT), this._graphics._applyTextProperties()) : this._textSize
      }, d.prototype.textStyle = function(a) {
        return arguments.length ? ((a === e.NORMAL || a === e.ITALIC || a === e.BOLD) && this._setProperty("_textStyle", a), this._graphics._applyTextProperties()) : this._textStyle
      }, d.prototype.textWidth = function(a) {
        return this._graphics.textWidth(a)
      ...
      }, d.prototype._isOpenType = function(a) {
        ...
        var g = d[1] - e[1],
          h = g - f;
        return document.body.removeChild(c), this._setProperty("_textAscent", f), this._setProperty("_textDescent", h), this
    ...
    50: [function(a, b, c) {
      ...
      a("../core/error_helpers"), d.prototype.text = function(a, b, c, d, e) {
        return this._validateParameters("text", arguments, [
          ["*", "Number", "Number"],
          ["*", "Number", "Number", "Number", "Number"]
        ]), this._doFill || this._doStroke ? this._graphics.text.apply(this._graphics, arguments) : this
      }, d.prototype.textFont = function(a, b) {
        if (arguments.length) {
          if (!a) throw Error("null font passed to textFont");
          return this._setProperty("_textFont", a), b && (this._setProperty("_textSize", b), this._setProperty("_textLeading", b * e._DEFAULT_LEADMULT)), this._graphics._applyTextProperties()
        }
        return this
      }, b.exports = d
    }, {
    ...
    51: [function(a, b, c) {
      ...
      function d() {
        for (var a = Array.prototype.slice.call(arguments), b = a.length, c = ""; b--;) c += a[b] === Object(a[b]) ? JSON.stringify(a[b]) : a[b];
        return c
      }
      var e = a("../core/core"),
        f = a("../core/constants");
      e.Font = function(a) {
        ...
        b = void 0 !== b ? b : 0, c = void 0 !== c ? c : 0, e = e || this.parent._textSize;
        ...
        if (!g) {
          ...
          this.font.forEachGlyph(a, b, c, e, f, function(a, b, c, d) {
            if (l.push(b), m.push(c), "space" !== a.name) {
              var f = a.getMetrics();
              l.push(b + f.xMax * o), m.push(c + -f.yMin * o), m.push(c + -f.yMax * o)
            } else l.push(b + n.font.charToGlyph(" ").advanceWidth * n._scale(e))
        ...
        var e = this.parent,
          f = e._graphics.drawingContext,
          g = this._handleAlignment(e, f, a, b, c);
        return this.font.getPath(a, g.x, g.y, e._textSize, d)
        ...
        var e, g = this.parent,
          h = g._graphics,
          i = h.drawingContext;
        e = "object" == typeof a && a.commands ? a.commands : this._getPath(a, b, c, g._textSize, d).commands, i.beginPath();
        for (var j = 0; j < e.length; j += 1) {
          var k = e[j];
          "M" === k.type ? i.moveTo(k.x, k.y) : "L" === k.type ? i.lineTo(k.x, k.y) : "C" === k.type ? i.bezierCurveTo(k.x1, k.y1, k.x2, k.y2, k.x, k.y) : "Q" === k.type ? i.quadraticCurveTo(k.x1, k.y1, k.x, k.y) : "Z" === k.type && i.closePath()
        }
        return g._doStroke && g._strokeSet && i.stroke(), g._doFill && (i.fillStyle = g._fillSet ? i.fillStyle : f._DEFAULT_TEXT_FILL, i.fill()), this
        ...
        return 1 / this.font.unitsPerEm * (a || this.parent._textSize)
...
function(a) {
  if ("object" == typeof exports && "undefined" != typeof module) module.exports = a();
    ...
    var b;
    b = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, b.opentype = a()
  }
}(function() {
  return function a(b, c, d) {
    function e(g, h) {
    ...
    3: [function(a, b, c) {
      ...
      function g(a) {
        ...
        switch (a.version) {
          case 1:
            ...
            break;
          case 2:
            for (this.names = new Array(a.numberOfGlyphs), b = 0; b < a.numberOfGlyphs; b++) this.names[b] = a.glyphNameIndex[b] < c.standardNames.length ? c.standardNames[a.glyphNameIndex[b]] : a.names[a.glyphNameIndex[b] - c.standardNames.length];
            break;
          case 2.5:
      ...
      function h(a) {
        for (var b, c = a.tables.cmap.glyphIndexMap, d = Object.keys(c), e = 0; e < d.length; e += 1) {
          var f = d[e],
            g = c[f];
          b = a.glyphs[g], b.addUnicode(parseInt(f))
        }
        for (e = 0; e < a.glyphs.length; e += 1) b = a.glyphs[e], b.name = a.cffEncoding ? a.cffEncoding.charset[e] : a.glyphNames.glyphIndexToName(e)
      }
      ...
      d.prototype.charToGlyphIndex = function(a) {
        ...
        for (var d = 0; d < c.length; d += 1)
          for (var e = c[d], f = 0; f < e.unicodes.length; f += 1)
    ...
    5: [function(a, b, c) {
      ...
      function d(a) {
        this.font = a.font || null, this.index = a.index || 0, this.name = a.name || null, this.unicode = a.unicode || void 0, this.unicodes = a.unicodes || void 0 !== a.unicode ? [a.unicode] : [], this.xMin = a.xMin || 0, this.yMin = a.yMin || 0, this.xMax = a.xMax || 0, this.yMax = a.yMax || 0, this.advanceWidth = a.advanceWidth || 0, this.path = a.path || null
      }
      var e = a("./check"),
        f = a("./draw"),
        g = a("./path");
      d.prototype.addUnicode = function(a) {
        0 === this.unicodes.length && (this.unicode = a), this.unicodes.push(a)
      }, d.prototype.getPath = function(a, b, c) {
        a = void 0 !== a ? a : 0, b = void 0 !== b ? b : 0, c = void 0 !== c ? c : 72;
        for (var d = 1 / this.font.unitsPerEm * c, e = new g.Path, f = this.path.commands, h = 0; h < f.length; h += 1) {
          var i = f[h];
        ...
        return e.argument(0 === b.length, "There are still points left in the current contour."), a
      ...
      }, d.prototype.drawPoints = function(a, b, c, d) {
        function e(b, c, d, e) {
          var f = 2 * Math.PI;
          a.beginPath();
        ...
        for (var f = 1 / this.font.unitsPerEm * d, g = [], h = [], i = this.path, j = 0; j < i.commands.length; j += 1) {
          var k = i.commands[j];
          void 0 !== k.x && g.push({
            x: k.x,
            y: -k.y
    ...
    6: [function(a, b, c) {
      ...
      function g(a) {
        ...
        return k.supported && (k.kerningPairs = g ? u.parse(m, g) : {}, h && q.parse(m, h, k)), k
      }
    ...
    10: [function(a, b, c) {
      ...
      function q(a, b, c) {
        ...
        function e() {
          var a;
          a = l.length % 2 !== 0, a && !n && (o = l.shift() + b.nominalWidthX), m += l.length >> 1, l.length = 0, n = !0
        }

        function f(a) {
          for (var s, t, u, v, w, x, y, z, A, B, C, D, E = 0; E < a.length;) {
            var F = a[E];
            switch (E += 1, F) {
              case 1:
                e();
              ...
              case 3:
                ...
                break;
              case 4:
                l.length > 1 && !n && (o = l.shift() + b.nominalWidthX, n = !0), r += l.pop(), d(q, r);
                break;
              case 5:
              ...
              case 8:
                ...
                break;
              case 10:
                w = l.pop() + b.subrsBias, x = b.subrs[w], x && f(x);
                break;
              case 11:
                return;
              case 12:
                switch (F = a[E], E += 1, F) {
                  ...
                  case 37:
                    ...
                    break;
                  default:
                    console.log("Glyph " + c + ": unknown operator 1200" + F), l.length = 0
                }
                break;
              case 14:
                l.length > 0 && !n && (o = l.shift() + b.nominalWidthX, n = !0), p && (k.closePath(), p = !1);
                break;
              case 18:
                e();
                break;
              ...
              case 20:
                ...
                break;
              case 21:
                l.length > 2 && !n && (o = l.shift() + b.nominalWidthX, n = !0), r += l.pop(), q += l.pop(), d(q, r);
                break;
              case 22:
                l.length > 1 && !n && (o = l.shift() + b.nominalWidthX, n = !0), q += l.pop(), d(q, r);
                break;
              case 23:
                e();
                break;
              ...
              case 27:
                ...
                break;
              case 28:
                s = a[E], t = a[E + 1], l.push((s << 24 | t << 16) >> 16), E += 2;
                break;
              case 29:
                w = l.pop() + b.gsubrsBias, x = b.gsubrs[w], x && f(x);
                break;
              case 30:
              ...
              case 31:
                ...
                break;
              default:
                32 > F ? console.log("Glyph " + c + ": unknown operator " + F) : 247 > F ? l.push(F - 139) : 251 > F ? (s = a[E], E += 1, l.push(256 * (F - 247) + s + 108)) : 255 > F ? (s = a[E], E += 1, l.push(256 * -(F - 251) - s - 108)) : (s = a[E], t = a[E + 1], u = a[E + 2], v = a[E + 3], E += 4, l.push((s << 24 | t << 16 | u << 8 | v) / 65536))
            }
          }
        }
        ...
        return s.path = k, s.advanceWidth = o, s
      }
      ...
      function s(a, b, c) {
        ...
        c.cffEncoding = 0 === k.encoding ? new H.CffEncoding(H.cffStandardEncoding, x) : 1 === k.encoding ? new H.CffEncoding(H.cffExpertEncoding, x) : p(a, b + k.encoding, x), c.encoding = c.encoding || c.cffEncoding, c.glyphs = [];
        for (var y = 0; y < c.nGlyphs; y += 1) {
          var z = w.objects[y];
          c.glyphs.push(q(z, c, y))
        }
      }
      ...
      function G(a, b) {
        for (var c = new L.Table("CFF ", [{
            ...
            charStrings: 999,
            "private": [0, 999]
          }, e = {}, f = [], g = 1; g < a.length; g += 1) f.push(a[g].name);
        var h = [];
        c.header = u(), c.nameIndex = v([b.postScriptName]);
        var i = x(d, h);
        c.topDictIndex = y(i), c.globalSubrIndex = A(), c.charsets = B(f, h), c.charStringsIndex = D(a);
        var j = E(e, h);
        c.privateDictIndex = F(j), c.stringIndex = z(h);
        var k = c.header.sizeOf() + c.nameIndex.sizeOf() + c.topDictIndex.sizeOf() + c.stringIndex.sizeOf() + c.globalSubrIndex.sizeOf();
        return d.charset = k, d.encoding = 0, d.charStrings = d.charset + c.charsets.sizeOf(), d["private"][1] = d.charStrings + c.charStringsIndex.sizeOf(), i = x(d, h), c.topDictIndex = y(i), c
      }
      var H = a("../encoding"),
        I = a("../glyph"),
        J = a("../parse"),
    ...
    11: [function(a, b, c) {
      ...
      function g(a) {
        ...
        for (c.segments = [], b = 0; b < a.length; b += 1) {
          for (var d = a[b], g = 0; g < d.unicodes.length; g += 1) e(c, d.unicodes[g], b);
    ...
    12: [function(a, b, c) {
      ...
      function e(a, b, c, e) {
        var f = new l.Parser(a, b),
          g = new k.Glyph({
            font: e,
            index: c
          });
        g.numberOfContours = f.parseShort(), g.xMin = f.parseShort(), g.yMin = f.parseShort(), g.xMax = f.parseShort(), g.yMax = f.parseShort();
        var h, i;
        if (g.numberOfContours > 0) {
          var m, n = g.endPointIndices = [];
          for (m = 0; m < g.numberOfContours; m += 1) n.push(f.parseUShort());
          for (g.instructionLength = f.parseUShort(),
            g.instructions = [], m = 0; m < g.instructionLength; m += 1) g.instructions.push(f.parseByte());
          var o = n[n.length - 1] + 1;
          for (h = [], m = 0; o > m; m += 1)
            if (i = f.parseByte(), h.push(i), (8 & i) > 0)
              for (var p = f.parseByte(), q = 0; p > q; q += 1) h.push(i), m += 1;
          if (j.argument(h.length === o, "Bad flags."), n.length > 0) {
            var r, s = [];
            if (o > 0) {
              for (m = 0; o > m; m += 1) i = h[m], r = {}, r.onCurve = !!(1 & i), r.lastPointOfContour = n.indexOf(m) >= 0, s.push(r);
              var t = 0;
              for (m = 0; o > m; m += 1) i = h[m], r = s[m], r.x = d(f, i, t, 2, 16), t = r.x;
              var u = 0;
              for (m = 0; o > m; m += 1) i = h[m], r = s[m], r.y = d(f, i, u, 4, 32), u = r.y
            }
            g.points = s
          } else g.points = []
        } else if (0 === g.numberOfContours) g.points = [];
        else {
          g.isComposite = !0, g.points = [], g.components = [];
          for (var v = !0; v;) {
            h = f.parseUShort();
            var w = {
              glyphIndex: f.parseUShort(),
              xScale: 1,
              scale01: 0,
              scale10: 0,
              yScale: 1,
            ...
            (1 & h) > 0 ? (w.dx = f.parseShort(), w.dy = f.parseShort()) : (w.dx = f.parseChar(), w.dy = f.parseChar()), (8 & h) > 0 ? w.xScale = w.yScale = f.parseF2Dot14() : (64 & h) > 0 ? (w.xScale = f.parseF2Dot14(), w.yScale = f.parseF2Dot14()) : (128 & h) > 0 && (w.xScale = f.parseF2Dot14(), w.scale01 = f.parseF2Dot14(), w.scale10 = f.parseF2Dot14(), w.yScale = f.parseF2Dot14()), g.components.push(w), v = !!(32 & h)
          }
        }
        return g
      }
      ...
      function g(a) {
        ...
        return j.argument(0 === c.length, "There are still points left in the current contour."), b
      }
      ...
      function h(a) {
        ...
        for (var c = g(a), d = 0; d < c.length; d += 1) {
          ...
          for (var k = f ? 1 : 0; k < h.length; k += 1) {
            var l = h[k],
              n = 0 === k ? i : h[k - 1];
            if (n.onCurve && l.onCurve) b.lineTo(l.x, l.y);
            else if (n.onCurve && !l.onCurve) e = l;
            else if (n.onCurve || l.onCurve) {
              if (n.onCurve || !l.onCurve) throw new Error("Invalid state.");
              ...
              b.quadraticCurveTo(n.x, n.y, o.x, o.y), e = l
            }
          }
      ...
      function i(a, b, c, d) {
        var g, i = [];
        for (g = 0; g < c.length - 1; g += 1) {
          var j = c[g],
            l = c[g + 1];
          i.push(j !== l ? e(a, b + j, g, d) : new k.Glyph({
            font: d,
            index: g
          }))
        }
        for (g = 0; g < i.length; g += 1) {
          var m = i[g];
          if (m.isComposite)
            for (var n = 0; n < m.components.length; n += 1) {
              var o = m.components[n],
                p = i[o.glyphIndex];
              if (p.points) {
                var q = f(p.points, o);
                m.points = m.points.concat(q)
              }
            }
          m.path = h(m.points)
        }
    ...
    23: [function(a, b, c) {
      ...
      function j(a) {
        for (var b = [], c = [], d = [], f = [], j = [], k = [], l = [], v = null, w = 0, x = 0, y = 0, z = 0, A = 0, B = 0; B < a.glyphs.length; B += 1) {
          var C = a.glyphs[B],
            D = 0 | C.unicode;
          (v > D || null === v) && (v = D), D > w && (w = D);
          ...
          if (".notdef" !== C.name) {
            var F = C.getMetrics();
            b.push(F.xMin), c.push(F.yMin), d.push(F.xMax), f.push(F.yMax), k.push(F.leftSideBearing), l.push(F.rightSideBearing), j.push(C.advanceWidth)
          }
        }
        var G = {
          xMin: Math.min.apply(null, b),
          yMin: Math.min.apply(null, c),
          xMax: Math.max.apply(null, d),
          yMax: Math.max.apply(null, f),
          advanceWidthMax: Math.max.apply(null, j),
          advanceWidthAvg: i(j),
    ...
    24: [function(a, b, c) {
      ...
      i.BYTE = function(a) {
      ...
      }, j.NUMBER32 = d(4), i.NAME = i.CHARARRAY, j.NAME = j.CHARARRAY, i.STRING = i.CHARARRAY, j.STRING = j.CHARARRAY, i.UTF16 = function(a) {
        ...
        else c = c.concat("SID" === b ? i.NUMBER(a) : "offset" === b ? i.NUMBER32(a) : i.NUMBER(a));
        return c
