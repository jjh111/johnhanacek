...
(function(Hypersolid) {
  ...
  DEFAULT_VIEWPORT_WIDTH = 1500; // Width of canvas in pixels
  DEFAULT_VIEWPORT_HEIGHT = 883; // Height of canvas in pixels
  ...
  function Viewport(argv) {
    ...
    canvas.onmousedown = function(e) {
      ...
      //startCoords.x -= Math.floor(mouseX, canvas.width/2);
      //startCoords.y = Math.floor(mouseY, canvas.width/2) - startCoords.y;
